...
def calcular_valores_subred(subred_ingresada, broadcast_red, broadcast_completo, prefijo_usado, paso_dado, lista_valores):
    if paso_dado == False:    
        octetos_ip = []
        octetos_broadcast_subred = []
        ...
        rango_host_utilizables = (valor_direccion_puerta_enlace + " - " + valor_direccion_ultima_utilizable)
        lista_valores_subredes = lista_valores
        lista_valores_subredes.append([subred_ingresada, rango_host_utilizables, valor_red_broadcast])
        
        if broadcast_red == broadcast_completo:
            calcular_valores_subred(valor_subred_siguiente, valor_subred_siguiente_broadcast, broadcast_completo, prefijo_usado, True, lista_valores_subredes)
        else:
            calcular_valores_subred(valor_subred_siguiente, valor_subred_siguiente_broadcast, broadcast_completo, prefijo_usado, False, lista_valores_subredes)
        return lista_valores_subredes