...
from calculo_valores_subredes import calcular_valores_subred, calcular_broadcast_red_siguiente
import sys
...
print("Máscara de Subred:", valor_mascara_subred)
...
print(valor_direccion_red_completa)

print("-----------------------------------------------------------------------")
print("Lista de Subredes Disponibles")
calcular_valores_subred(valor_direccion_red_completa, valor_broadcast_red_completa, valor_broadcast_completo, prefijo_valor, False)